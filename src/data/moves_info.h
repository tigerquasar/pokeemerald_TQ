...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_FIRE_PUNCH] =
    {
        ...
        .punchingMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_BURN_COUNTER,
            .chance = 12,
        }),
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
    ...
    [MOVE_ICE_PUNCH] =
    {
        ...
        .punchingMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_FREEZE_OR_FROSTBITE_COUNTER,
            .chance = 12,
        }),
        .contestEffect = CONTEST_EFFECT_HIGHLY_APPEALING,
    ...
    [MOVE_POISON_STING] =
    {
        ...
        .piercingMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_POISON_COUNTER,
    ...
    [MOVE_ACID] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
            .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_DEF_MINUS_1_COUNTER,
    ...
    [MOVE_PSYBEAM] =
    {
        ...
        .beamMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_CONFUSION_COUNTER,
            .chance = 12,
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_SHIFT_JUDGE_ATTENTION : CONTEST_EFFECT_SCRAMBLE_NEXT_TURN_ORDER,
        .contestCategory = CONTEST_CATEGORY_BEAUTY,
    ...
    [MOVE_BUBBLE_BEAM] =
    {
        ...
        .beamMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SPD_MINUS_1_COUNTER,
            .speed = 1,
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 10 : 33,
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_STARTLE_PREV_MON : CONTEST_EFFECT_BADLY_STARTLE_PREV_MONS,
    ...
    [MOVE_AURORA_BEAM] =
    {
        ...
        .lightMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_ATK_MINUS_1_COUNTER,
            .attack = 1,
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 10 : 33,
        }),
    ...
    [MOVE_CONSTRICT] =
    {
        ...
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SPD_MINUS_1_COUNTER,
            .speed = 1,
            .chance = B_UPDATED_MOVE_DATA >= GEN_2 ? 12 : 33,
        }),
    ...
    [MOVE_OCTAZOOKA] =
    {
        ...
        .ballisticMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_ACC_MINUS_1_COUNTER,
            .accuracy = 1,
            .chance = 30,
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_REPETITION_NOT_BORING : CONTEST_EFFECT_STARTLE_MON_WITH_JUDGES_ATTENTION,
    ...
    [MOVE_STEEL_WING] =
    {
        ...
        .ignoresKingsRock = B_UPDATED_MOVE_FLAGS < GEN_3,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_DEF_PLUS_1_COUNTER,
            .defense = 1,
            .self = TRUE,
            .chance = 12,
        }),
    ...
    [MOVE_IRON_TAIL] =
    {
        ...
        .whipingMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_DEF_MINUS_1_COUNTER,
            .defense = 1,
            .chance = 20,
        }),
        .contestEffect = C_UPDATED_MOVE_EFFECTS >= GEN_6 ? CONTEST_EFFECT_HIGHLY_APPEALING : CONTEST_EFFECT_BADLY_STARTLE_FRONT_MON,
    ...
    [MOVE_METAL_CLAW] =
    {
        ...
        .clawMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_ATK_PLUS_1_COUNTER,
            .attack = 1,
            .self = TRUE,
            .chance = 12,
        }),
    ...
    [MOVE_ANCIENT_POWER] =
    {
        ...
        .makesContact = B_UPDATED_MOVE_DATA < GEN_4,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_OMNIBOOST_COUNTER,
            .attack = 1,
            .defense = 1,
            .spDef = 1,
            .spAtk = 1,
    ...
    [MOVE_MIST_BALL] =
    {
        ...
        .ballisticMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_ATK_MINUS_1_COUNTER,
            .spAtk = 1,
            .chance = 30,
        }),
    ...
    [MOVE_POISON_FANG] =
    {
        ...
        .bitingMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_TOXIC_COUNTER,
    ...
    [MOVE_METEOR_MASH] =
    {
        ...
        .punchingMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_ATKT_PLUS_1_COUNTER,
            .attack = 1,
            .self = TRUE,
            .chance = 15,
        }),
    ...
    [MOVE_CHARGE_BEAM] =
    {
        ...
        .beamMove = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_ATK_PLUS_1_COUNTER,
            .spAtk = 1,
            .self = TRUE,
            .chance = 70,
        }),
    ...
    [MOVE_SEED_FLARE] =
    {
        ...
        .category = DAMAGE_CATEGORY_SPECIAL,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SP_DEF_MINUS_2_COUNTER,
            .spDef = 2,
            .chance = 24,
        }),
        .contestEffect = CONTEST_EFFECT_USER_MORE_EASILY_STARTLED,
    ...
    [MOVE_RELIC_SONG] =
    {
        ...
        .metronomeBanned = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_SLEEP_COUNTER,
            .chance = 12,
        }),
        .contestEffect = CONTEST_EFFECT_MAKE_FOLLOWING_MONS_NERVOUS,
    ...
    [MOVE_DIAMOND_STORM] =
    {
        ...
        .metronomeBanned = TRUE,
        .additionalEffects = ADDITIONAL_EFFECTS({
            .moveEffect = MOVE_EFFECT_DEF_PLUS_2_COUNTER,
